...
- [x] `make ops7-demo` incident drill evidence 추가
- [x] postmortem report screenshot 추가
- [x] GitHub Actions Ops7 gate evidence 추가
- [ ] TODO: evidence needed - 최종 Velog 게시 전 incident duration 수치와 report 경로 재확인
