...
범위 기준은 [Development Roadmap](./docs/04-development-roadmap.md), [Infra Operations Extension Plan](./docs/19-infra-operations-extension.md), [Incident Runbook Index](./docs/26-incident-runbook-index.md)에 연결한다.
...
- Blog: `blog/19-incident-runbook-oncall-simulation.md`
