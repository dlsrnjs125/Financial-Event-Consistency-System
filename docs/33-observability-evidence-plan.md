...
아래 명령은 Ops Phase 구현 과정에서 Makefile target과 연결한다.

| Scenario | 재현 명령 | 결과 파일 |
|---|---|---|
| Normal Load | `make k6-normal` | `reports/k6/normal-load-summary.json` |
| Peak Load | `make k6-peak` | `reports/k6/peak-load-summary.json` |
| Duplicate Storm | `make k6-duplicate-storm` | `reports/k6/duplicate-storm-summary.json` |
| Redis Down | `make drill-redis-down` | `reports/incidents/redis-down-result.md` |
| DB Pressure | `make drill-db-pressure` | `reports/incidents/db-pressure-result.md` |
| Nginx Burst | `make drill-nginx-burst` | `reports/k6/nginx-rate-limit-summary.json` |
| DR Drill | `make dr-drill` | `reports/dr-drill/backup-restore-result.md` |
