...
- 현재 위치: **Phase 8 Metrics, Logging, Observability 구현 완료**
- GitHub 초기 Push: **완료**
- 다음 단계: **Phase 9 k6 부하 테스트와 성능 비교**
...
실제 p95/p99/RPS/error rate 수치와 Redis 적용 전후 비교는 Phase 9 k6/PostgreSQL 환경에서 측정한다.
...
| 다음 | 9. k6 부하 테스트와 성능 비교 | 설계 선택 수치 검증 | k6 시나리오, 실험 기록, 비교표 | p95/p99/error/duplicate rate 기록 |
