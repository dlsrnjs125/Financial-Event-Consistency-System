...
| PH-Impl 10 | 선택 | mock partner, outbound HTTP wrapper, blackbox probe | 외부 dependency 지연 검증 |
...
PH-Impl 9는 PH1~PH8 hardening drill을 운영 관점에서 묶는 단계이며, PH10/PH11 latency attribution 구현 완료를 의미하지 않는다.
