...
> 기존 Dev/Ops Track에서 검증한 정합성 원칙을 유지하면서, 실제 운영 환경에서 PostgreSQL 장애, 자동 진단, 복구 승인, 민감 데이터 보호 기준을 보완한다.
...
| Phase | 목표 | 주요 산출물 | Status |
| --- | --- | --- | --- |
| PH Phase 0 | Production Readiness Gap Analysis | 이 문서, 로드맵 연결 | Planned |
| PH Phase 1 | PostgreSQL Failure Policy & Write Suspend 설계 | `36-postgres-failure-and-write-suspend-policy.md` | Planned |
| PH Phase 2 | Incident Diagnosis Automation 설계 | `37-incident-diagnosis-automation-design.md` | Planned |
| PH Phase 3 | Recovery Case / Quarantine / Manual Approval 설계 | `38-recovery-case-quarantine-and-reconciliation-design.md` | Planned |
| PH Phase 4 | Stale PROCESSING Recovery & Reconciliation 설계 | `38-recovery-case-quarantine-and-reconciliation-design.md` | Planned |
| PH Phase 5 | Sensitive Data Protection & AI Safe Governance 설계 | `39-sensitive-data-ai-governance-and-encryption-tradeoff.md` | Planned |
| PH Phase 6 | Partner Secret Rotation & HMAC Hardening 설계 | `39-sensitive-data-ai-governance-and-encryption-tradeoff.md`, `docs/28-secret-management-policy.md` | Planned |
| PH Phase 7 | PostgreSQL HA / Durable Queue Trade-off ADR | `40-postgres-ha-and-queue-tradeoff-adr.md` | Planned |
| PH Phase 8 | Production Hardening Drill 구현 계획 | 후속 Makefile/script/test 후보 | Planned |
