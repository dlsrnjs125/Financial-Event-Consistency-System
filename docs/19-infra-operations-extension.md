...
| Ops Phase | 이름 | 핵심 결과물 |
|---|---|---|
| 1 | Infra Metrics Extension | exporter, dashboard, monitoring evidence |
...
| 4 | PostgreSQL Backup/Restore DR Drill | backup, checksum, restore, consistency SQL, DR report |
| 5 | Failure Recovery Runbook Drill | Redis/API/PostgreSQL stop/start recovery evidence |
| 6 | Alerting & Incident Response Runbook | Prometheus alert rule, runbook, CI gate evidence |
| 7 | Incident Timeline & Postmortem Drill | Redis degraded incident timeline, postmortem, action item |
| 8 | Incident Runbook Finalization | incident runbook index, SLO/SLI, observability evidence, measurement template |
