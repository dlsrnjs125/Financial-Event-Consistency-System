...
Ops Phase 1~7은 같은 시스템을 실제 사내 인프라에서 운영한다고 가정하고, 다음 질문에 답하기 위한 운영 확장 설계다.
...
| 2 | Nginx Access Control | public/internal endpoint 분리 |
| 3 | Backup/Restore DR Drill | backup, restore, checksum, consistency SQL |
| 4 | Ansible Automation | idempotent playbook |
| 5 | PowerShell Operator Scripts | Windows 점검 스크립트 |
| 6 | Internal Network Security | endpoint 접근 정책, masking/DLP 기준 |
| 7 | Incident Runbook | 장애별 탐지/대응/복구 절차 |
